    ...
    if username:
        ...
        if send_slack_message:
            ...
            ##send_message(client, user_id, message)
                ...
                message = ("Hello!\nThis is the xxx OpenVPN Bot!  Your 'PC' VPN certificate has been generated!  We have posted instructions on the Confluence wiki at https://xxxxxx.atlassian.net/wiki/spaces/xxxxxxxxxxxxxxxx/pages/2501410834/How+to+replace+your+OpenVPN+Certificate+Renewals to help guide you through the necessary steps.\n\nYou should receive a certificate named \"" + ovpn_filename +"\".  Please follow the 'Windows PC and Mac Laptop' instructions to update your laptop certificate.\n\nIf you get stuck or encounter error messages, please open an issue in the CLOUDOPS Jira project so we can visit with you to resolve the problem.\nThank you!\nOpenVPN Bot")

                if is_mobile:
                     message = ("Hello!\nThis is the xxx OpenVPN Bot! Your 'Mobile' VPN certificate has been generated.  We have posted instructions on the Confluence wiki at https://xxxxxx.atlassian.net/wiki/spaces/xxxxxxxxxxxxxxxx/pages/2501410834/How+to+replace+your+OpenVPN+Certificate+Renewals to help guide you through the necessary steps installing the certificate.\n\nYou should receive a certificate named \"" + ovpn_filename +"\".  Please follow the 'Android' or 'IPhone' instructions appropriate for the mobile device you own.\n\nIf you get stuck or encounter error messages, please open an issue in the CLOUDOPS Jira project so we can visit with you to resolve the problem.\nThank you!\nOpenVPN Bot")
